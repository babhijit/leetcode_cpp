...
<img alt="" src="https://assets.leetcode.com/uploads/2019/01/19/example_1_before_65p.jpg" style="width: 250px; height: 149px;" />
<br /> &nbsp; 
<pre>
...
<strong>Explanation:</strong> The list is empty (given head is&nbsp;<span><code>null</code></span>). We create a new single circular list and return the reference to that single node.
</pre>
...
<div><div>Related Topics</div><div><li>Linked List</li></div></div><br><div><li>👍 1240</li><li>👎 788</li></div>